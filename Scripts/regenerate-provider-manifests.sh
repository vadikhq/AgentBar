...
PROVIDERS_FILE="${ROOT_DIR}/Sources/AgentBarCore/Providers/Providers.swift"
DESCRIPTOR_DIR="${ROOT_DIR}/Sources/AgentBarCore/Providers"
IMPLEMENTATION_DIR="${ROOT_DIR}/Sources/AgentBar/Providers"
