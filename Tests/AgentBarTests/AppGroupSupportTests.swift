...
struct AppGroupSupportTests {
    ...
    func `app group identifiers use resolved team-prefixed release and debug variants`() {
        #expect(
            AppGroupSupport.currentGroupID(teamID: "Y5PE65HELJ", bundleID: "com.vadikhq.agentbar")
                == "Y5PE65HELJ.com.vadikhq.agentbar")
        #expect(
            AppGroupSupport.currentGroupID(teamID: "ABCDE12345", bundleID: "com.vadikhq.agentbar.debug")
                == "ABCDE12345.com.vadikhq.agentbar.debug")
        #expect(
            AppGroupSupport.legacyGroupID(for: "com.vadikhq.agentbar")
                == "group.com.vadikhq.agentbar")
        #expect(
            AppGroupSupport.legacyGroupID(for: "com.vadikhq.agentbar.debug")
                == "group.com.vadikhq.agentbar.debug")
    }
