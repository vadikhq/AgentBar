...
struct StatusItemControllerSplitLifecycleTests {
    ...
    func `merged mode removes split provider status items`() throws {
        ...
        #expect(controller.expectedVisibleStatusItemAutosaveNames == ["agentbar-codex", "agentbar-claude"])
        ...
        #expect(controller.expectedVisibleStatusItemAutosaveNames == ["agentbar-merged"])
    }
    ...
    func `status items publish stable manager identity`() throws {
        ...
        #expect(controller.statusItem.autosaveName == "agentbar-merged")
        #expect(controller.statusItems[.codex]?.autosaveName == "agentbar-codex")
        #expect(controller.statusItems[.claude]?.autosaveName == "agentbar-claude")
        ...
        #expect(controller.statusItem.button?.accessibilityTitle() == "AgentBar")
        #expect(codexButton.accessibilityTitle() == "AgentBar")
        #expect(claudeButton.accessibilityTitle() == "AgentBar")
    ...
    func `status item identity returns stable autosave names`() {
        #expect(StatusItemController.StatusItemIdentity.merged.autosaveName == "agentbar-merged")
        #expect(StatusItemController.StatusItemIdentity.provider(.codex).autosaveName == "agentbar-codex")
        #expect(StatusItemController.StatusItemIdentity.provider(.claude).autosaveName == "agentbar-claude")
    }
    ...
    func `status item placement preflight leaves fresh install placement unset`() throws {
        ...
        let key = MenuBarStatusItemPlacementPreflight.preferredPositionKey(autosaveName: "agentbar-merged")

        #expect(!MenuBarStatusItemPlacementPreflight.prepare(defaults: defaults, autosaveName: "agentbar-merged"))
    ...
    func `status item placement preflight clears provider matching suspicious legacy placement`() throws {
        ...
        defaults.set(42, forKey: "NSStatusItem Preferred Position Item-0")
        defaults.set(11298, forKey: "NSStatusItem Preferred Position Item-1")
        let key = MenuBarStatusItemPlacementPreflight.preferredPositionKey(autosaveName: "agentbar-codex")

        #expect(MenuBarStatusItemPlacementPreflight.prepare(
            defaults: defaults,
            autosaveName: "agentbar-codex",
    ...
    func `status item defaults repair removes stale hidden Control Center keys once`() throws {
        ...
        defaults.set(false, forKey: "NSStatusItem VisibleCC agentbar-merged")
        ...
        #expect(repairedKeys == [
            ...
            "NSStatusItem VisibleCC agentbar-merged",
        ])
        ...
        #expect(defaults.object(forKey: "NSStatusItem VisibleCC agentbar-merged") == nil)
    ...
    func `status item visibility default distinguishes enabled disabled and unset`() throws {
        ...
        let defaults = try #require(UserDefaults(suiteName: suite))
        defaults.removePersistentDomain(forName: suite)
        defaults.set(true, forKey: "NSStatusItem VisibleCC agentbar-merged")
        defaults.set(false, forKey: "NSStatusItem VisibleCC agentbar-claude")
        defer { defaults.removePersistentDomain(forName: suite) }

        #expect(MenuBarStatusItemDefaultsRepair.visibilityDefault(
            defaults: defaults,
            autosaveName: "agentbar-merged") == true)
        #expect(MenuBarStatusItemDefaultsRepair.visibilityDefault(
            defaults: defaults,
            autosaveName: "agentbar-claude") == false)
        #expect(MenuBarStatusItemDefaultsRepair.visibilityDefault(
            defaults: defaults,
            autosaveName: "agentbar-codex") == nil)
    }
    ...
    func `non destructive visibility refresh preserves split provider status items`() throws {
        ...
        #expect(newCodexItem.autosaveName == "agentbar-codex")
