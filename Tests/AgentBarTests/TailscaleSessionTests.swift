...
struct TailscaleSessionTests {
    ...
    func `remote session command negotiates v2 then v1 for PATH and bundled CLIs`() {
        #expect(RemoteSessionFetcher.remoteSessionsCommand() ==
            "agentbar sessions --json-v2 || agentbar sessions --json || " +
            "'/Applications/AgentBar.app/Contents/Helpers/AgentBarCLI' sessions --json-v2 || " +
            "'/Applications/AgentBar.app/Contents/Helpers/AgentBarCLI' sessions --json")
    }
}
