...
struct PreferencesPaneSmokeTests {
    ...
    func `quota warning compact rows build with semantic threshold labels`() {
        ...
        AgentBarLocalizationOverride.$appLanguage.withValue("ru") {
    ...
    func `german app language resolves localized labels`() {
        ...
        AgentBarLocalizationOverride.$appLanguage.withValue("de") {
            ...
            #expect(L("quit_app") == "AgentBar beenden")
    ...
    func `italian language preference resolves italian strings`() {
        ...
        AgentBarLocalizationOverride.$appLanguage.withValue("it") {
            ...
            #expect(L("quit_app") == "Esci da AgentBar")
        }
    }
