...
struct UsagePaceTextTests {
    ...
    func `usage pace text localization keys exist in en and zh Hans with matching placeholders`() throws {
        ...
        let enURL = root.appendingPathComponent("Sources/AgentBar/Resources/en.lproj/Localizable.strings")
        let zhURL = root.appendingPathComponent("Sources/AgentBar/Resources/zh-Hans.lproj/Localizable.strings")
    ...
    func `session quota estimate template localizes CJK number unit spacing`() throws {
        ...
        for expectation in expectations {
            let url = root.appendingPathComponent(
                "Sources/AgentBar/Resources/\(expectation.language).lproj/Localizable.strings")
