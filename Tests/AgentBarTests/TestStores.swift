...
func testConfigStore(suiteName: String, reset: Bool = true) -> AgentBarConfigStore {
    ...
    return AgentBarConfigStore(fileURL: url)
}

@MainActor
func testConfigWithAllProvidersDisabled() -> AgentBarConfig {
    let metadata = ProviderRegistry.shared.metadata
    var config = AgentBarConfig.makeDefault(metadata: metadata)
