...
struct StatusItemBalanceDisplayTests {
    ...
    func `debug bundle identity updates status item accessibility`() {
        #expect(StatusItemController.isDebugApp(bundleIdentifier: "com.vadikhq.agentbar.debug"))
        #expect(!StatusItemController.isDebugApp(bundleIdentifier: "com.vadikhq.agentbar"))
