...
struct LocalizationBundleTests {
    ...
    func `packaged app resolves localization bundle from resources`() throws {
        ...
        #expect(bundle.bundleURL.lastPathComponent == "AgentBar_AgentBar.bundle")
        ...
        includeEmptyChineseLocalization: Bool = false) throws -> (root: URL, appBundle: Bundle)
    {
        let root = FileManager.default.temporaryDirectory.appendingPathComponent(
            "agentbar-localization-\(UUID().uuidString)",
            isDirectory: true)
        ...
        <dict>
            ...
            <key>CFBundleIdentifier</key><string>com.vadikhq.agentbar.tests</string>
        ...
        if includeLocalizationBundle {
            let bundleURL = resourcesURL.appendingPathComponent("AgentBar_AgentBar.bundle", isDirectory: true)
