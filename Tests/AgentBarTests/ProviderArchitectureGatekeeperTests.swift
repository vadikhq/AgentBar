...
struct ProviderArchitectureGatekeeperTests {
    ...
    func `every provider descriptor has a loadable SVG resource`() throws {
        let resources = try Self.repoRoot()
            .appending(path: "Sources/AgentBar/Resources", directoryHint: .isDirectory)
    ...
    func `provider implementation path identifies only a real provider folder`() {
        ...
        #expect(Self.providerImplementationID(
            "Sources/AgentBar/Providers/Claude/ClaudeSettings.swift",
            providerIDsByFolderName: folders) == "claude")
        #expect(Self.providerImplementationID(
            "Sources/AgentBar/Providers/Shared/ProviderHelpers.swift",
            providerIDsByFolderName: folders) == nil)
        #expect(Self.providerImplementationID(
            "Sources/AgentBar/NotProviders/ClaudeSettings.swift",
            providerIDsByFolderName: folders) == nil)
    }
    ...
    func `provider folders exempt only their own provider references`() {
        let file = SourceFile(
            path: "Sources/AgentBar/Providers/Claude/ClaudeSettings.swift",
    ...
    private static let suppressedProviderReferences: [SuppressedProviderReference] = [
        SuppressedProviderReference(
            path: "Sources/AgentBar/CodexAccountUsageSnapshotStore.swift",
            line: 220,
        ...
        SuppressedProviderReference(
            ...
            reason: "This provider-owned integration passes its fixed identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/CodexOwnershipContext.swift",
            line: 54,
            anchor: ".toUsageSnapshot(provider: .codex, accountEmail: normalizedEmail)",
            expectedProviderIDs: ["codex"],
            reason: "This provider-owned integration passes its fixed identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/CopilotTokenStore.swift",
            line: 25,
            anchor: "private static let log = AgentBarLog.logger(LogCategories.provider(.copilot, scope: \"token-store\"))",
        ...
        SuppressedProviderReference(
            path: "Sources/AgentBar/CursorLoginRunner.swift",
            line: 127,
            anchor: "private let logger = AgentBarLog.logger(LogCategories.provider(.cursor, scope: \"login\"))",
        ...
        SuppressedProviderReference(
            ...
            reason: "This provider-owned adapter passes its fixed identity to shared logging or cache infrastructure."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/KimiTokenStore.swift",
            line: 25,
            anchor: "private static let log = AgentBarLog.logger(LogCategories.provider(.kimi, scope: \"token-store\"))",
            expectedProviderIDs: ["kimi"],
            reason: "This provider-owned adapter passes its fixed identity to shared logging or cache infrastructure."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/MenuBarMetricWindowResolver.swift",
            line: 128,
        ...
        SuppressedProviderReference(
            ...
            reason: "This named provider resolver supplies its fixed provider identity to the shared presentation helper."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/MiniMaxAPITokenStore.swift",
            line: 25,
            anchor: "private static let log = AgentBarLog.logger(LogCategories.provider(.minimax, scope: \"api-token-store\"))",
            expectedProviderIDs: ["minimax"],
            reason: "This provider-owned adapter passes its fixed identity to shared logging or cache infrastructure."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/MiniMaxCookieStore.swift",
            line: 25,
            anchor: "private static let log = AgentBarLog.logger(LogCategories.provider(.minimax, scope: \"cookie-store\"))",
            expectedProviderIDs: ["minimax"],
            reason: "This provider-owned adapter passes its fixed identity to shared logging or cache infrastructure."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/PredictivePaceWarnings.swift",
            line: 206,
        ...
        SuppressedProviderReference(
            path: "Sources/AgentBar/PreferencesProvidersPane+Testing.swift",
            line: 83,
        ...
        SuppressedProviderReference(
            ...
            reason: "This test-only app seam pins Codex fixture data and does not make production routing policy."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/SessionQuotaNotifications.swift",
            line: 460,
            anchor: "let removedState = self.sessionQuotaTransitionStates.removeValue(forKey: .codex)",
            expectedProviderIDs: ["codex"],
            reason: "This exact provider-owned construct passes a fixed identity to shared infrastructure."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/SettingsStore+MenuObservation.swift",
            line: 103,
        ...
        SuppressedProviderReference(
            ...
            reason: "This observation touchpoint reads a fixed provider field so UI invalidation tracks that setting."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/SpendDashboardController.swift",
            line: 432,
            anchor: "provider: .codex,",
            expectedProviderIDs: ["codex"],
        ...
        SuppressedProviderReference(
            path: "Sources/AgentBar/StatusItemController+CodexStackedMenu.swift",
            line: 26,
            anchor: "for: .codex,",
            expectedProviderIDs: ["codex"],
            reason: "This provider-owned integration passes its fixed identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/StatusItemController+CompactAccountMenu.swift",
            line: 74,
        ...
        SuppressedProviderReference(
            ...
            reason: "This provider-specific app branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/StatusItemController+MemoryPressure.swift",
            line: 45,
        ...
        SuppressedProviderReference(
            path: "Sources/AgentBar/StatusItemController+Menu.swift",
            line: 1100,
            anchor: "controller.refreshOpenMenuIfStillVisible(menu, provider: .codex)",
            expectedProviderIDs: ["codex"],
            reason: "This provider-specific app branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/SyntheticTokenStore.swift",
            line: 25,
            anchor: "private static let log = AgentBarLog.logger(LogCategories.provider(.synthetic, scope: \"token-store\"))",
            expectedProviderIDs: ["synthetic"],
            reason: "This provider-owned adapter passes its fixed identity to shared logging or cache infrastructure."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/UsageStore+Accessors.swift",
            line: 95,
            anchor: "accountID: self.settings.selectedTokenAccount(for: .deepseek)?.id,",
            expectedProviderIDs: ["deepseek"],
            reason: "This provider-specific app branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/UsageStore+ClaudeDebug.swift",
            line: 111,
            anchor: "for: .claude,",
            expectedProviderIDs: ["claude"],
            reason: "This provider-owned integration passes its fixed identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/UsageStore+CodexCostCatchUp.swift",
            line: 28,
        ...
        SuppressedProviderReference(
            ...
            reason: "This provider-owned integration passes its fixed identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/UsageStore+HighestUsage.swift",
            line: 161,
            anchor: "let windows = IconRemainingResolver.resolvedWindows(snapshot: snapshot, style: .antigravity)",
            expectedProviderIDs: ["antigravity"],
            reason: "This named provider resolver supplies its fixed provider identity to the shared presentation helper."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/UsageStore+HistoricalPace.swift",
            line: 154,
        ...
        SuppressedProviderReference(
            ...
            reason: "This provider-specific app branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/UsageStore+PlanUtilization.swift",
            line: 177,
            anchor: "self.sessionEquivalentBurnCache.removeValue(forKey: .codex)",
            expectedProviderIDs: ["codex"],
            reason: "This provider-specific app branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/UsageStore+Refresh.swift",
            line: 333,
        ...
        SuppressedProviderReference(
            ...
            reason: "This provider-specific app branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/UsageStore+RefreshEnrichment.swift",
            line: 279,
        ...
        SuppressedProviderReference(
            ...
            reason: "This provider-specific app branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/UsageStore+SpendDashboardCodexCostCatchUp.swift",
            line: 20,
            anchor: "self.settings.isCostUsageEffectivelyEnabled(for: .codex),",
            expectedProviderIDs: ["codex"],
            reason: "This Codex account projection passes its fixed provider identity to shared spend infrastructure."),
        ...
        SuppressedProviderReference(
            ...
            reason: "This Codex account projection passes its fixed provider identity to shared spend infrastructure."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/UsageStore+TokenAccounts.swift",
            line: 841,
        ...
        SuppressedProviderReference(
            ...
            reason: "This provider-specific app branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/UsageStore+TokenCost.swift",
            line: 92,
        ...
        SuppressedProviderReference(
            ...
            reason: "This provider-specific app branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/UsageStore+WidgetSnapshot.swift",
            line: 286,
        ...
        SuppressedProviderReference(
            ...
            reason: "Claude widget quota ownership uses the selected Claude account's isolated snapshot key."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/UsageStore.swift",
            line: 1070,
        ...
        SuppressedProviderReference(
            ...
            reason: "This provider-specific app branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/ZaiTokenStore.swift",
            line: 25,
            anchor: "private static let log = AgentBarLog.logger(LogCategories.provider(.zai, scope: \"token-store\"))",
            expectedProviderIDs: ["zai"],
            reason: "This provider-owned adapter passes its fixed identity to shared logging or cache infrastructure."),
        SuppressedProviderReference(
            path: "Sources/AgentBarCLI/CLICardsRenderer.swift",
            line: 221,
            anchor: "provider: .claude,",
            expectedProviderIDs: ["claude"],
            reason: "This provider-specific app branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            ...
            reason: "This provider-specific app branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/AgentBarCLI/CLICostCommand.swift",
            line: 239,
        ...
        SuppressedProviderReference(
            ...
            reason: "The Cursor-only cookie-settings resolver passes its fixed identity to token-account helpers."),
        SuppressedProviderReference(
            path: "Sources/AgentBarCore/CodexLocalProjectUsageIndexer.swift",
            line: 64,
            anchor: "provider: .codex,",
            expectedProviderIDs: ["codex"],
            reason: "This provider-owned integration passes its fixed identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/AgentBarCore/CostUsageFetcher.swift",
            line: 307,
            anchor: "provider: .codex,",
            expectedProviderIDs: ["codex"],
        ...
        SuppressedProviderReference(
            ...
            reason: "This provider-specific core branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/AgentBarCore/LocalAgentSessionScanner.swift",
            line: 298,
            anchor: "provider: .codex,",
            expectedProviderIDs: ["codex"],
            reason: "This provider-specific core branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/AgentBarCore/OpenAIWeb/OpenAIDashboardBrowserCookieImporter.swift",
            line: 150,
        ...
        SuppressedProviderReference(
            ...
            reason: "This provider-owned adapter passes its fixed identity to shared logging or cache infrastructure."),
        SuppressedProviderReference(
            path: "Sources/AgentBarCore/OpenAIWeb/OpenAIDashboardWebViewCache.swift",
            line: 16,
            anchor: "fileprivate static let log = AgentBarLog.logger(LogCategories.provider(.openai, scope: \"webview\"))",
            expectedProviderIDs: ["openai"],
            reason: "This provider-owned adapter passes its fixed identity to shared logging or cache infrastructure."),
        SuppressedProviderReference(
            path: "Sources/AgentBarCore/ProviderStorageFootprint.swift",
            line: 146,
            anchor: "provider: .claude,",
            expectedProviderIDs: ["claude"],
        ...
        SuppressedProviderReference(
            ...
            reason: "This inventory row records the provider that owns its static storage location."),
        SuppressedProviderReference(
            path: "Sources/AgentBarCore/Providers/ProviderDiagnosticExport.swift",
            line: 414,
        ...
        SuppressedProviderReference(
            path: "Sources/AgentBarCore/UsageFetcher.swift",
            line: 1500,
            anchor: "providerID: .codex,",
            expectedProviderIDs: ["codex"],
            reason: "This provider-specific core branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/AgentBar/GeminiLoginRunner.swift",
            line: 7,
        ...
        SuppressedProviderReference(
            path: "Sources/AgentBar/UsageStore+OpenAIWeb.swift",
            line: 1572,
        ...
        SuppressedProviderReference(
            path: "Sources/AgentBarCore/AgentSession.swift",
            line: 412,
        ...
        SuppressedProviderReference(
            path: "Sources/AgentBarCore/DarwinProcessEnumerator.swift",
            line: 9,
        ...
        SuppressedProviderReference(
            path: "Sources/AgentBarCore/Providers/Antigravity/AntigravityStatusProbe.swift",
            line: 211,
            anchor: "matching: { $0.lowercased().contains(\"gemini\") },",
            expectedProviderIDs: ["gemini"],
            reason: "Antigravity quota payloads use this token to identify a model family, not a AgentBar provider."),
        SuppressedProviderReference(
            path: "Sources/AgentBarCore/Providers/Antigravity/AntigravityStatusProbe.swift",
            line: 214,
        ...
        SuppressedProviderReference(
            ...
            reason: "Antigravity quota titles use this token to rank a model family."),
        SuppressedProviderReference(
            path: "Sources/AgentBarCore/Providers/AzureOpenAI/AzureOpenAIUsageFetcher.swift",
            line: 172,
        ...
        SuppressedProviderReference(
            path: "Sources/AgentBarCore/Providers/Gemini/GeminiStatusProbe.swift",
            line: 146,
        ...
        SuppressedProviderReference(
            path: "Sources/AgentBarCore/Providers/OpenCodeGo/OpenCodeGoLocalUsageReader.swift",
            line: 39,
        ...
        SuppressedProviderReference(
            path: "Sources/AgentBarCore/Providers/ProviderVersionDetector.swift",
            line: 147,
        ...
        SuppressedProviderReference(
            path: "Sources/AgentBarWidget/BurnDownWidgetProvider.swift",
            line: 180,
            anchor: "provider: .codex,",
            expectedProviderIDs: ["codex"],
        ...
        SuppressedProviderReference(
            ...
            reason: "This WidgetKit default or preview pins the established Codex sample provider."),
        SuppressedProviderReference(
            path: "Sources/AgentBarWidget/AgentBarWidgetProvider.swift",
            line: 78,
    ...
    private static let allowedProviderConstructs: [AllowedProviderConstruct] = [
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact shared construct dispatches a provider-owned capability at the generic integration boundary."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/CostHistoryChartMenuView.swift",
            line: 1116,
        ...
        AllowedProviderConstruct(
            path: "Sources/AgentBar/HistoricalUsagePace.swift",
            line: 221,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact shared construct dispatches a provider-owned capability at the generic integration boundary."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/IconRenderer.swift",
            line: 691,
            ...
            reason: "This exact shared renderer maps provider-owned presentation data into the generic UI model."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/InlineUsageDashboardContent.swift",
            line: 268,
            ...
            reason: "This exact shared renderer maps provider-owned presentation data into the generic UI model."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/MenuBarLayout.swift",
            line: 788,
            ...
            reason: "This exact shared construct dispatches a provider-owned capability at the generic integration boundary."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/MenuBarLayoutEditor.swift",
            line: 904,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact shared construct dispatches a provider-owned capability at the generic integration boundary."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/MenuCardView+CodexResetCredits.swift",
            line: 122,
            ...
            reason: "This exact shared renderer maps provider-owned presentation data into the generic UI model."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/MenuCardView+Costs.swift",
            line: 204,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact shared renderer maps provider-owned presentation data into the generic UI model."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/MenuCardView+Kiro.swift",
            line: 7,
            ...
            reason: "This exact shared renderer maps provider-owned presentation data into the generic UI model."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/MenuCardView+ModelHelpers.swift",
            line: 198,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact shared renderer maps provider-owned presentation data into the generic UI model."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/MenuCardView+ProviderDetailLocalization.swift",
            line: 11,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact shared renderer maps provider-owned presentation data into the generic UI model."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/MenuCardView.swift",
            line: 200,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact shared renderer maps provider-owned presentation data into the generic UI model."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/MenuDescriptor.swift",
            line: 203,
            anchor: "case .codex: \"⌘\"",
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact shared renderer maps provider-owned presentation data into the generic UI model."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/MenuOpenRefreshPlan.swift",
            line: 28,
        ...
        AllowedProviderConstruct(
            path: "Sources/AgentBar/PreferencesProvidersPane.swift",
            line: 274,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/PreferencesSpendDashboardPane.swift",
            line: 352,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/Providers/Shared/ProviderTokenAccountSelection.swift",
            line: 28,
        ...
        AllowedProviderConstruct(
            path: "Sources/AgentBar/ShareStatsPayload.swift",
            line: 195,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact shared construct dispatches a provider-owned capability at the generic integration boundary."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/SettingsStore+MenuPreferences.swift",
            line: 259,
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/SettingsStore.swift",
            line: 1192,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact shared construct dispatches a provider-owned capability at the generic integration boundary."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/SpendDashboardModel+ModelBreakdown.swift",
            line: 122,
            ...
            reason: "This exact shared construct dispatches a provider-owned capability at the generic integration boundary."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/SpendDashboardModel.swift",
            line: 1089,
            ...
            reason: "This exact shared construct dispatches a provider-owned capability at the generic integration boundary."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/StatusItemController+AccountMenuDisplay.swift",
            line: 122,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/StatusItemController+Actions.swift",
            line: 387,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/StatusItemController+Animation.swift",
            line: 572,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/StatusItemController+CostMenuCard.swift",
            line: 129,
            ...
            reason: "This exact shared renderer maps provider-owned presentation data into the generic UI model."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/StatusItemController+CountdownRefresh.swift",
            line: 166,
            anchor: "if providers.contains(.codex) {",
            expectedProviderIDs: ["codex"],
            expectedReferenceCount: 2,
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/StatusItemController+HostedSubmenus.swift",
            line: 443,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/StatusItemController+MenuBarLayout.swift",
            line: 209,
            anchor: "if provider == .codex,",
            expectedProviderIDs: ["codex"],
            expectedReferenceCount: 1,
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/StatusItemController+MenuSwitcherWarmup.swift",
            line: 70,
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/StatusItemController+MenuTracking.swift",
            line: 373,
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/StatusItemController+MenuTypes.swift",
            line: 14,
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/StatusItemController+MenuViewportRestore.swift",
            line: 611,
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/StatusItemController+OverviewSubmenus.swift",
            line: 10,
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/StatusItemController+ProviderNavigation.swift",
            line: 59,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/StatusItemController+SwitcherMetrics.swift",
            line: 16,
            anchor: "} else if provider == .mistral {",
            expectedProviderIDs: ["mistral"],
            expectedReferenceCount: 1,
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/StatusItemController.swift",
            line: 367,
            anchor: "if provider == .codex {",
            expectedProviderIDs: ["codex"],
            expectedReferenceCount: 1,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/UsageStore+LimitResetCelebration.swift",
            line: 180,
        ...
        AllowedProviderConstruct(
            path: "Sources/AgentBar/UsageStore+LimitResetIdentity.swift",
            line: 11,
            anchor: "if provider == .codex {",
            expectedProviderIDs: ["codex"],
            expectedReferenceCount: 1,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/UsageStore+ProviderStorage.swift",
            line: 253,
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/UsageStore+QuotaWarnings.swift",
            line: 132,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/UsageStore+SessionEquivalents.swift",
            line: 183,
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/UsageStore+SessionQuotaTransition.swift",
            line: 54,
            anchor: "if provider == .codex,",
            expectedProviderIDs: ["codex"],
            expectedReferenceCount: 2,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/AgentBarCLI/CLICardsCommand.swift",
            line: 170,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact CLI construct preserves the provider-specific command and output contract."),
        AllowedProviderConstruct(
            path: "Sources/AgentBarCLI/CLIUsageCommand.swift",
            line: 182,
            anchor: "includeAllCodexAccounts: tokenSelection.allAccounts && providerList == [.codex],",
            expectedProviderIDs: ["codex"],
            expectedReferenceCount: 1,
        ...
        AllowedProviderConstruct(
            path: "Sources/AgentBarCore/CodexLocalDataScope.swift",
            line: 29,
            ...
            reason: "This exact shared construct dispatches a provider-owned capability at the generic integration boundary."),
        AllowedProviderConstruct(
            path: "Sources/AgentBarCore/Config/AgentBarConfig.swift",
            line: 172,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact host integration maps a provider-owned process, path, or window contract."),
        AllowedProviderConstruct(
            path: "Sources/AgentBarCore/OpenAIDashboardModels.swift",
            line: 146,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact shared construct dispatches a provider-owned capability at the generic integration boundary."),
        AllowedProviderConstruct(
            path: "Sources/AgentBarCore/PiSessionCostScanner.swift",
            line: 231,
            anchor: "guard provider == .codex || provider == .claude else { return nil }",
            expectedProviderIDs: ["claude", "codex"],
            expectedReferenceCount: 2,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact cost scanner dispatch selects a provider-owned transcript, cache, or pricing format."),
        AllowedProviderConstruct(
            path: "Sources/AgentBarCore/ProviderEndpointOverrideValidator.swift",
            line: 9,
        ...
        AllowedProviderConstruct(
            path: "Sources/AgentBarCore/PathEnvironment.swift",
            line: 561,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact shared provider integration dispatches a capability owned by the provider descriptor or adapter."),
        AllowedProviderConstruct(
            path: "Sources/AgentBarCore/Providers/ProviderCredentialAdapter.swift",
            line: 56,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact shared provider integration dispatches a capability owned by the provider descriptor or adapter."),
        AllowedProviderConstruct(
            path: "Sources/AgentBarCore/Providers/ProviderFetchPlan.swift",
            line: 231,
            anchor: "if provider == .kiro {",
            expectedProviderIDs: ["kiro"],
            expectedReferenceCount: 1,
            ...
            reason: "This exact shared provider integration dispatches a capability owned by the provider descriptor or adapter."),
        AllowedProviderConstruct(
            path: "Sources/AgentBarCore/SessionWindowFocuser.swift",
            line: 70,
            ...
            reason: "This exact host integration maps a provider-owned process, path, or window contract."),
        AllowedProviderConstruct(
            path: "Sources/AgentBarCore/UsageSnapshot+SwitcherWeeklyWindow.swift",
            line: 11,
            anchor: "case .factory:",
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact shared construct dispatches a provider-owned capability at the generic integration boundary."),
        AllowedProviderConstruct(
            path: "Sources/AgentBarCore/Vendored/CostUsage/CostUsagePricing.swift",
            line: 222,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact cost scanner dispatch selects a provider-owned transcript, cache, or pricing format."),
        AllowedProviderConstruct(
            path: "Sources/AgentBarCore/Vendored/CostUsage/ModelsDevPricing.swift",
            line: 80,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact WidgetKit construct preserves its compile-time provider selection contract."),
        AllowedProviderConstruct(
            path: "Sources/AgentBar/UsageStore+SpendDashboardPublication.swift",
            line: 85,
        ...
        AllowedProviderConstruct(
            path: "Sources/AgentBarCore/Providers/Antigravity/AntigravityOfflineStore.swift",
            line: 17,
    ...
    private static func isLoggingCall(openingParenthesis: String.Index, in text: String) -> Bool {
        ...
        return identifiers.dropLast().contains { identifier in
            identifier == "log" || identifier == "logger" || identifier == "AgentBarLog" ||
