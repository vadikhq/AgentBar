...
public enum BrowserCookieAccessGate {
    ...
    private static let log = AgentBarLog.logger(LogCategories.browserCookieGate)
    ...
    static let allowTestCookieAccessEnvironmentKey = "AGENTBAR_ALLOW_TEST_BROWSER_COOKIE_ACCESS"
