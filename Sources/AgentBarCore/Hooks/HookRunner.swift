...
public enum HookRunner {
    private static let log = AgentBarLog.logger(LogCategories.hooks)
    public static let maximumPayloadBytes = 4096

    /// Environment keys forwarded to a hook. Deliberately narrow: AgentBar's own
