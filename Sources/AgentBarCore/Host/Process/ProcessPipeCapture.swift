...
package final class ProcessPipeCapture: @unchecked Sendable {
    ...
    #if os(Linux)
    private let readerQueue = DispatchQueue(label: "com.vadikhq.AgentBar.process-pipe-capture.reader")
    private let callbackQueue = DispatchQueue(label: "com.vadikhq.AgentBar.process-pipe-capture.callback")
