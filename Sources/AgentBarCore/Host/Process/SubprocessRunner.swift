...
public enum SubprocessRunnerError: LocalizedError, Sendable {
    ...
    public var errorDescription: String? {
        ...
        case let .binaryNotFound(binary):
            return "Missing CLI '\(binary)'. Install it and restart AgentBar."
...
public enum SubprocessRunner {
    private static let log = AgentBarLog.logger(LogCategories.subprocess)
    private static let timeoutQueue = DispatchQueue(
        label: "com.vadikhq.agentbar.subprocess.timeout",
        qos: .userInitiated,
