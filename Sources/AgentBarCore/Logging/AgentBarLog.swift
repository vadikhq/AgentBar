...
public enum AgentBarLog {
    ...
    public static func logger(_ category: String) -> AgentBarLogger {
        let logger = Logger(label: "com.vadikhq.agentbar.\(category)")
        return AgentBarLogger(isEnabled: { level in
...
public struct AgentBarLogger: Sendable {
    private let isEnabled: @Sendable (AgentBarLog.Level) -> Bool
    private let logFn: @Sendable (AgentBarLog.Level, String, [String: String]?) -> Void

    fileprivate init(
        isEnabled: @escaping @Sendable (AgentBarLog.Level) -> Bool,
        log: @escaping @Sendable (AgentBarLog.Level, String, [String: String]?) -> Void)
    {
    ...
    init(
        minimumLevel: AgentBarLog.Level,
        log: @escaping @Sendable (AgentBarLog.Level, String, [String: String]?) -> Void)
    {
