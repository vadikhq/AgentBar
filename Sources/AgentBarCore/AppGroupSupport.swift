...
public enum AppGroupSupport {
    ...
    public static let legacyReleaseGroupID = "group.com.vadikhq.agentbar"
    public static let legacyDebugGroupID = "group.com.vadikhq.agentbar.debug"
    ...
    static func currentGroupID(teamID: String, bundleID: String?) -> String {
        let base = "\(teamID).com.vadikhq.agentbar"
