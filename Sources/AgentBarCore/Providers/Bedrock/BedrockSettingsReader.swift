...
public enum BedrockSettingsReader {
    ...
    public static let budgetKey = "AGENTBAR_BEDROCK_BUDGET"
    public static let apiURLKey = "AGENTBAR_BEDROCK_API_URL"
    public static let cloudWatchAPIURLKey = "AGENTBAR_BEDROCK_CLOUDWATCH_API_URL"
    public static let profileKey = "AWS_PROFILE"
    public static let authModeKey = "AGENTBAR_BEDROCK_AUTH_MODE"
