...
/// Safe resolver for AgentBarCore's SwiftPM resource bundle.
///
/// The autogenerated `Bundle.module` accessor traps at launch when the packaged
/// app does not place `AgentBar_AgentBarCore.bundle` at the locations it probes
...
public enum AgentBarCoreResources {
    static let missingBundleMessage =
        "AgentBarCore resource bundle is missing next to the executable; reinstall or update AgentBar"
    ...
    {
        let name = "AgentBar_AgentBarCore"
    ...
    private static let defaultSwiftPMBuildDirectory: URL = {
        let packageRoot = URL(fileURLWithPath: #filePath)
            .deletingLastPathComponent() // AgentBarCore
