...
extension AgentBarCLI {
    ...
    static func configSettingAPIKey(
        ...
        apiKey: String,
        enableProvider: Bool,
        accountOptions: ConfigAPIKeyAccountOptions? = nil) -> AgentBarConfig
    {
    ...
    static func configProviderStatuses(_ config: AgentBarConfig) -> [ConfigProviderStatusResult] {
