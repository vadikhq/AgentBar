...
extension CLIServeWebUI {
    ...
    <head>
      ...
      <title>AgentBar Dashboard</title>
      <style>
        :root {
    ...
    <body>
      <main class="shell">
        ...
        <section id="auth" class="notice" aria-labelledby="auth-title">
          ...
          <p>Enter the bearer token configured for this AgentBar server.</p>
      ...
      <script>
        ...
        const tokenKey = "agentbar.dashboardToken";
        const snapshotKey = "agentbar.lastSnapshot";
