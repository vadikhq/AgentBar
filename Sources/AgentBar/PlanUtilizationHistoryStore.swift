...
struct PlanUtilizationHistoryBuckets: Equatable, Sendable {
    ...
    private static let unscopedIdentityKey = "__agentbar_unscoped__"
    private static let invalidatedIdentity = "__agentbar_invalidated__"
...
struct PlanUtilizationHistoryStore: Sendable {
    ...
    private static func defaultDirectoryURL() -> URL? {
        ...
        let dir = root.appendingPathComponent("com.vadikhq.agentbar", isDirectory: true)
