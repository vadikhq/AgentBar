...
extension SettingsStore {
    ...
    var isVerboseLoggingEnabled: Bool {
        self.debugLogLevel.rank <= AgentBarLog.Level.verbose.rank
    }
    ...
    var claudeOAuthDirectKeychainReadAllowed: Bool {
        ...
        set {
            ...
            if wasAllowed, !newValue {
                ...
                // Code's Keychain while consent was on live in AgentBar's memory and Keychain caches, and
                ...
                // (AgentBar-owned state only — Claude Code's item is untouched).
