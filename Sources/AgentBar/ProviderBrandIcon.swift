...
enum ProviderBrandIcon {
    ...
    private static let resourceBundle: Bundle? = {
        ...
        // SwiftPM creates a AgentBar_AgentBar.bundle for resources in the AgentBar target.
        if let bundleURL = Bundle.main.url(forResource: "AgentBar_AgentBar", withExtension: "bundle"),
