...
enum AgentBarLocalizationOverride {
...
private func appLanguageDefaults() -> UserDefaults {
    ...
    return UserDefaults(suiteName: "AgentBar") ?? .standard
}
...
private func resolvedAppLanguage() -> String {
    if let override = AgentBarLocalizationOverride.appLanguage {
        return override
    }
...
func codexBarLocalizationResourceBundle(
    ...
    bundleName: String = "AgentBar_AgentBar") -> Bundle
{
    ...
    guard mainBundle === Bundle.main, bundleName == "AgentBar_AgentBar" else {
...
func resetAgentBarLocalizationCache() {
...
func resetAgentBarLocalizationCacheForTesting() {
