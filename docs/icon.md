---
summary: "Convert macOS .icon bundles to AgentBar .icns via Scripts/build_icon.sh and ictool."
read_when:
  - Updating the AgentBar app icon or asset pipeline
...
## Script
`Scripts/build_icon.sh ICON.icon AgentBar [outdir]`
