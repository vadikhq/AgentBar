...
```bash
agentbar usage --provider abacusai --verbose
```
...
Log in to [apps.abacus.ai](https://apps.abacus.ai) in a supported browser (Safari, Chrome, Firefox), then refresh AgentBar.
