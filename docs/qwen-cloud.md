...
Log in at `https://home.qwencloud.com/billing/subscription/token-plan-individual` in Chrome, then refresh AgentBar.
...
Your Qwen Cloud session is stale. Sign out and back in on the Qwen Cloud console, then refresh AgentBar.
