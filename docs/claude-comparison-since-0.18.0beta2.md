...
flowchart TD
    ...
    I --> J{"Refresh status"}
    J -- "200" --> K["Save refreshed creds to AgentBar keychain cache + memory"]
...
```mermaid
flowchart TD
    A["load(...)"] --> B["Environment token (AGENTBAR_CLAUDE_OAUTH_TOKEN)"]
    B -->|miss| C["Memory cache (valid + unexpired)"]
    C -->|miss| D["AgentBar keychain cache: com.vadikhq.agentbar.cache/oauth.claude"]
...
- `/Users/ratulsarna/Developer/staipete/AgentBar/Sources/AgentBarCore/Providers/Claude/ClaudeUsageFetcher.swift`
- `/Users/ratulsarna/Developer/staipete/AgentBar/Sources/AgentBarCore/Providers/Claude/ClaudeProviderDescriptor.swift`
- `/Users/ratulsarna/Developer/staipete/AgentBar/Sources/AgentBarCore/Providers/Claude/ClaudeOAuth/ClaudeOAuthCredentials.swift`
- `/Users/ratulsarna/Developer/staipete/AgentBar/Sources/AgentBarCore/Providers/Claude/ClaudeOAuth/ClaudeOAuthKeychainAccessGate.swift`
- `/Users/ratulsarna/Developer/staipete/AgentBar/Sources/AgentBarCore/Providers/Claude/ClaudeOAuth/ClaudeOAuthRefreshFailureGate.swift`
- `/Users/ratulsarna/Developer/staipete/AgentBar/Sources/AgentBarCore/KeychainAccessPreflight.swift`
- `/Users/ratulsarna/Developer/staipete/AgentBar/Sources/AgentBarCore/KeychainNoUIQuery.swift`
- `/Users/ratulsarna/Developer/staipete/AgentBar/Sources/AgentBarCore/BrowserCookieImportOrder.swift`
- `/Users/ratulsarna/Developer/staipete/AgentBar/Sources/AgentBarCore/BrowserCookieAccessGate.swift`
